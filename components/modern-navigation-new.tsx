    ...
    <React.Fragment>
      ...
      >
        <div className="max-w-6xl mx-auto px-2 sm:px-4 flex justify-between items-center">
          ...
          {/* BotÃ³n Admisiones 2025 para mÃ³vil */}
          ...
          >
            <Link href="/egresados" className="hover:text-blue-300 transition-colors duration-200"
                  style={{ display: "none" }} // Oculta el enlace directo, ya estÃ¡ en el dropdown
            >
              Egresados
            </Link>
                ...
                {activeSecondaryDropdown === "biblioteca" && (
                  ...
                  >
                    ...
                    <Link
                      ...
                      className="flex items-center justify-between px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-900 transition-colors duration-200"
                    >
                      <span>Revistas de investigaciÃ³n UNMSM</span>
                      <ExternalLink className="h-3 w-3" />
                    </Link>
                    <Link
                    ...
                    <Link
                      ...
                      className="flex items-center justify-between px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-900 transition-colors duration-200"
                    >
                      <span>Ãndex de EnfermerÃ­a</span>
                      <ExternalLink className="h-3 w-3" />
                    </Link>
                    <Link
                    ...
                    <Link
                      ...
                      className="flex items-center justify-between px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-900 transition-colors duration-200"
                    >
                      <span>Revista MÃ©dica del Instituto Mexicano del Seguro Social</span>
                      <ExternalLink className="h-3 w-3" />
                    </Link>
                    <Link
                      ...
                      className="flex items-center justify-between px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-900 transition-colors duration-200"
                    >
                      <span>Escuela de EnfermerÃ­a y ObstÃ©trica</span>
                      <ExternalLink className="h-3 w-3" />
                    </Link>
                    <Link
        ...
        <nav className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            >
              ...
              {/* Noticias - Con efecto llamativo */}
              <Link
                href="/noticias"
                className="relative text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 px-4 py-2 rounded-full text-sm font-bold transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl group overflow-hidden"
              >
                        ...
                        <div className="ml-6">
                          ...
                          >
                            <div>
                              ...
                              <div className="text-xs text-gray-500">Revista cientÃ­fica de salud</div>
                            </div>
                          </Link>
                        </div>
                      </div>
                      ...
                      <div className="px-4 py-2">
                        ...
                        <div className="space-y-2 ml-6">
                          <div className="block p-3 rounded-lg bg-gray-50 cursor-not-allowed opacity-60">
                            <div className="font-medium text-sm text-gray-600">PrÃ³ximamente...</div>
                            <div className="text-xs text-gray-500">En actualizaciÃ³n</div>
                          </div>
                          ...
                          >
                            <div className="font-medium text-sm">EnfermerÃ­a</div>
                            <div className="text-xs text-gray-500">Licenciatura - 5 aÃ±os</div>
                          </Link>
                          <Link
                            href="/carreras/farmacia-bioquimica"
                            className="block p-3 rounded-lg hover:bg-blue-50 hover:text-blue-900 transition-colors duration-200"
                          >
                            <div className="font-medium text-sm">Farmacia y BioquÃ­mica</div>
                            <div className="text-xs text-gray-500">QuÃ­mico FarmacÃ©utico - 5 aÃ±os</div>
                          </Link> */}
                        </div>
                      </div>
                    </motion.div>
              ...
              <SheetContent side="right" className="w-80 bg-white border-l border-gray-200">
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex-1 py-4 space-y-4 overflow-y-auto">
                    ...
                    <Link
                      href="/noticias"
                      className="block relative overflow-hidden text-white bg-gradient-to-r from-blue-600 to-blue-700 font-bold py-3 px-4 rounded-lg transition-all duration-200 shadow-md"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      <span className="flex items-center gap-2">
                        <span>ðŸ“°</span> Noticias UNIDx
                        <span className="text-xs bg-yellow-400 text-blue-900 px-2 py-0.5 rounded-full font-bold animate-pulse">Nuevo</span>
                      </span>
                    </Link>
                    ...
                    <div className="space-y-2 pt-4 border-t border-gray-200">
                      <div className="text-sm font-medium text-gray-700 mb-3">Enlaces RÃ¡pidos</div>
                      <Link
                        href="/egresados"
            ...
            <div className="text-center space-y-6">
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                <div className="flex items-center justify-center space-x-3 mb-4">
                  ...
                  <div className="text-left">
                    <p className="text-sm text-blue-600 font-medium">Fecha de InscripciÃ³n</p>
                    <p className="text-2xl font-bold text-blue-900">10 de febrero, 2026</p>
                  </div>
                </div>
                <p className="text-blue-700 text-sm">
                  El proceso de admisiones se abriÃ³ oficialmente el 10 de febrero de 2026
                </p>
              </div>
              ...
              <div className="bg-orange-50 rounded-xl p-6 border border-orange-200">
                <div className="flex items-center justify-center space-x-3 mb-4">
                  ...
                  <div className="text-left">
                    <p className="text-sm text-orange-600 font-medium">Fecha de Examen de AdmisiÃ³n</p>
                    <p className="text-2xl font-bold text-orange-900">28 de marzo, 2026</p>
                  </div>
                </div>
                <p className="text-orange-700 text-sm">
                  El examen de admisiÃ³n se llevarÃ¡ a cabo el 28 de marzo de 2026
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="text-left">
                      <p className="font-medium text-gray-900 text-sm">Â¿Quieres ser notificado?</p>
                      <p className="text-gray-600 text-xs mt-1">
                        RegÃ­strate para recibir informaciÃ³n sobre fechas importantes, requisitos y modalidades de
                        ingreso.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                  <p className="font-medium text-green-900 text-sm mb-2">InformaciÃ³n y Consultas</p>
